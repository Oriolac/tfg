...
\begin{enumerate}
	...
	Es requereix que $13 \cdot l$ sigui igual o més gran que la llargada en bits de $p$. Per tal de passar-ho de manera segura sense que la subestació pugui saber una part del secret del comptador, s'usa el protocol de Busom \cite{busom} enviant $l$ paquets en la fase de transmissió corresponent al nombre de chunks a enviar.
